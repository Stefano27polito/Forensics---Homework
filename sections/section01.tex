...
In a cloud investigation, there is no single artefact to acquire: what NovaDynamics' cloud provider gives you is a set of \emph{exports}, such as logs, metadata listings, billing reports, each produced by a different internal system of the provider, on a different schedule, with
